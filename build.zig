...
const renderer_sources = [_][]const u8{ "src/renderers/md4x-html.c", "src/renderers/md4x-ast.c", "src/renderers/md4x-ansi.c", "src/renderers/md4x-meta.c", "src/renderers/md4x-text.c", "src/renderers/md4x-heal.c", "src/entity.c" };
